                            ...
                            double  pFilmOffsetY)
{
    ...
    // gluPerspectivef(pFieldOfViewY, 
    //     pAspect, 
    //     pNearPlane, 
    //     pFarPlane);
    // glMatrixMode(GL_MODELVIEW);
    // glLoadIdentity();
    // gluLookAtf(pEye[0], pEye[1], pEye[2],
    //     pCenter[0], pCenter[1], pCenter[2],
    //     pUp[0], pUp[1], pUp[2]);
    gl4duBindMatrix("projectionMatrix");
    gl4duLoadIdentityf();
    gl4duPerspectivef(pFieldOfViewY, 
        pAspect, 
        pNearPlane, 
        pFarPlane);
    gl4duBindMatrix("modelViewMatrix");
    gl4duLoadIdentityf();
    gl4duLookAtf(pEye[0], pEye[1], pEye[2],
        pCenter[0], pCenter[1], pCenter[2],
        pUp[0], pUp[1], pUp[2]);
}
...
void GlDrawCamera(FbxAMatrix& pGlobalPosition, double pRoll)
{
    ...
    gl4duPushMatrix();
    gl4duRotated(pRoll, 1.0, 0.0, 0.0);
...
void GlDrawCrossHair(FbxAMatrix& pGlobalPosition)
{
    ...
    // glMultMatrixd((double*) pGlobalPosition);
    gl4duPushMatrix();
    gl4duMultMatrixd((double*) pGlobalPosition);
